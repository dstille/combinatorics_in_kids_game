...
IN = 'in'
AFFIRM = 'yes'
PODDS = 'Enter the odds or probability that %s will be herded.\nFor odds enter __ in __ ; for probability enter _.__ : '
...
DCHECK_ODDS = 'We are going to check the odds that %s get herded by Bear'

DQADULTS_SETS = 'queried adults subsets:   '
DADULTS_SETS  = 'adult sets:               '
DQKIDS_SETS =   'queried kids subsets:     '
DKIDS_SETS =    'kid sets:                 '
DQCOMBINED_SETS = 'combined queried subsets:  '
DCOMINED_SETS = 'combined sets:            '
