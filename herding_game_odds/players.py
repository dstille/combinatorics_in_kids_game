from combinatorics import Combinations, Combinatorics
...
class Players:
    def __init__(self, players, num_chosen, query) -> None:
        ...
        self.queried_set = Combinatorics.format_as_sets([self.queried_players])
        self.nonqueried_players, self.num_nonqueried = self.get_nonqueried_players(query)
        self.nonqueried_set = Combinatorics.format_as_sets([self.nonqueried_players])
