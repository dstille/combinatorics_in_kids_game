...
def hint(combos, players, check_odds_names):
    print(XSTR.SIZE_HINT % (players.num_chosen-players.num_queried, players.nonqueried_set, SetRepr(players.queried_players)))  
...
def prob_display(combos, players):
    ...
    return f'{qcombo_value}/{combos.combo_value}', f'{qcombo_value.value}/{combos.combo_value.value}', f'{qcombo_value/combos.combo_value:.2f}'
...
def format_math(combos, players):
    a1, a2, a3 = prob_display(combos, players)
    return f' {a1} = {a2} = {a3}'
